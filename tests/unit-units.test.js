...
class MockSelectElement {
    ...
    appendChild(option) {
        ...
        // option.parentElement = this; // Removed: Avoid assigning to happy-dom's readonly parentElement
    ...
    removeChild(option) {
        ...
        if (index > -1) {
            ...
            // if (removed) removed.parentElement = null; // Removed: Avoid assigning to happy-dom's readonly parentElement
    ...
    remove(index) {
        if (index >= 0 && index < this._options.length) {
            ...
            // if (removedOption) removedOption.parentElement = null; // Removed: Avoid assigning to happy-dom's readonly parentElement
            if (this._selectedIndex === index) {
                this._selectedIndex = -1; // Reset if removed selected
            } else if (this._selectedIndex > index) {
                this._selectedIndex--; // Adjust if selected index was after removed
...
class MockDivElement {
    ...
    appendChild(child) {
        ...
        // }
        // child.parentElement = this; // Removed: Avoid assigning to happy-dom's readonly parentElement
    }
    ...
    removeChild(child) {
        ...
        if (index > -1) {
            ...
            // child.parentElement = null; // Removed: Avoid assigning to happy-dom's readonly parentElement
        }
    }
